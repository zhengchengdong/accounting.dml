...
public class AccountingTest {
	...
	public void doTest() {
		...
		AccountingRecord ar = a1.deposit(0.00001, new TextAccountingSummary("测试存款"));
		...
		try {
			ar = a1.withdraw(1, new TextAccountingSummary("测试取款"));
			assertTrue(false);
		...
		try {
			ar = a1.withdraw(0.000001, new TextAccountingSummary("测试取款"));
